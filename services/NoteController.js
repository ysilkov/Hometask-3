...
var NoteService_js_1 = require("../repositories/NoteService.js");
var NoteController = /** @class */ (function () {
    ...
    NoteController.prototype.edit = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var editNote, e_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, NoteService_js_1["default"].edit(req.params.id, req.body)];
                    case 1:
                        editNote = _a.sent();
                        return [2 /*return*/, res.json(editNote)];
                    case 2:
                        e_4 = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, NoteService_js_1["default"].statistic()];
                    case 1:
                        note = _a.sent();
                        return [2 /*return*/, res.json(note)];
                    case 2:
